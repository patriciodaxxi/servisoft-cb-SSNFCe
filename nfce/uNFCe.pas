...
begin
  ...
  vMSGNFCe := '';
  fDMParametros := TdmParametros.Create(nil);
end;
...
begin
  ...
  if Sincrono then
  begin
//   PCNAuxiliar.GerarChaveAcesso(ChaveNfe,
...
//                           Texto);
     GerarChaveAcesso(fDMNFCe.qUFCODUF.AsInteger,
                      fDMCupomFiscal.cdsCupomFiscalDTEMISSAO.AsDateTime,
                      Texto,
                      StrToInt(vSerieAux),
                      StrToInt(vNumNotaAux),
...
procedure TfNFCe.prc_configura_ACBr;
begin
...
begin
  ...
  fDMNFCe.ACBrNFe.NotasFiscais.LoadFromFile('C:\a\XMLSaoJose\NFCe_01_S001_253755_43190994161890000167650010002537551673267667.xml');
